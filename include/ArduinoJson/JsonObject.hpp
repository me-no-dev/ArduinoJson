...
class JsonObject : public Internals::JsonPrintable<JsonObject>,
 ...
 public:
  ...
  FORCE_INLINE bool set(const char* key, signed long long value);
  ...
  FORCE_INLINE bool set(const char* key, unsigned long long value);
  ...
  FORCE_INLINE bool set(const String& key, signed long long value);
  ...
  FORCE_INLINE bool set(const String& key, unsigned long long value);
