...
class JsonObject : public Internals::JsonPrintable<JsonObject>,
 ...
 public:
  ...
  FORCE_INLINE bool set(const char* key, int64_t value);
  ...
  FORCE_INLINE bool set(const char* key, uint64_t value);
  ...
  FORCE_INLINE bool set(const String& key, int64_t value);
  ...
  FORCE_INLINE bool set(const String& key, uint64_t value);
